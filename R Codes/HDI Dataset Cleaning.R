...
## set working directory to HDI Datasets Raw
##setwd("C:/NTU/Business/Y2 S1/Analytics/AY21 Team Assignment and Project/HDI Datasets Raw")
...
write.csv(data,"C:\\NTU\\Business\\Y2S1\\Analytics\\AY21 Team Assignment and Project\\HDIdata.csv", row.names = FALSE)
...
write.csv(wdata,"C:\\NTU\\Business\\Y2S1\\Analytics\\AY21 Team Assignment and Project\\Indexdata.csv", row.names = FALSE)
